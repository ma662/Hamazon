...
// display products then inquirer
...
var app = {
    ...
    //     function (err, res) {
    //         for (var i=0; i<res.length; i++) {
    //             idChoices.push(res[i].item_id + " - " + res[i].product_name);
    //         }
    ...
    //                                 name: "quantity",
    //                                 type: "input",
    //                                 message: "What quantity would you like to purchase for " + "[" + res[0].product_name + "] ?",
    //                                 validate: function(value) {
    //                                     if (value <= res[0].stock_quantity && value > -1) {
    //                                         return true;
    //                                     }
    //                                     else {
    //                                         console.log("\nNot a valid quantity amount.\n");
